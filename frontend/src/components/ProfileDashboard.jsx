...
import { FaUserCircle, FaEdit, FaEnvelope, FaPhone, FaMapMarkerAlt, FaLock } from "react-icons/fa";
...
const ProfileDashboard = () => {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-white to-blue-100">
            <div className="w-full max-w-3xl bg-white shadow-lg border border-gray-200 rounded-lg p-8 space-y-8">
                {/* Header Section */}
