...
const Correction = () => {
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-white to-blue-100">
      <div className="w-full max-w-5xl bg-white text-gray-800 rounded-lg overflow-hidden shadow-xl flex flex-col">
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 bg-gray-300 text-white">
          {/* History Icon on the Left */}
          <button className="text-gray-50 text-xl hover:text-gray-200 transition duration-200 p-0">
            <AiOutlineHistory />
          </button>
        ...
        <div className="px-6 py-4 border-b border-gray-200">
          <div className="flex justify-between items-center mb-2">
            <h2 className="text-base font-semibold text-gray-800">Letter Title 1</h2>
